<script lang="ts">
    ...
    Object.entries(creativityTemp).forEach(([key, value]) => creativityCount.push(value));
    Object.entries(activityTemp).forEach(([key, value]) => activityCount.push(value));
    Object.entries(serviceTemp).forEach(([key, value]) => serviceCount.push(value));
...
<canvas {width} {height} id="byCategoryChart"></canvas>
