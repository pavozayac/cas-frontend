<script lang="ts">
    ...
    let [profileStore, profileReload] = swr(
        currentProfile,
        "currentProfile",
        []
    );
            ...
            <div class="profile-info">
                ...
                <div class="detail-info">
                    <InformationTile
                        ...
                        label="Description">{group.description}</InformationTile
                    >
                    <InformationTile iconName="star" label="Date of creation"
                        >{new Date(group.date_created).getDate()}
                        {new Date(group.date_created).toLocaleString("en-us", {
                            month: "short",
                        })}
                        {new Date(group.date_created).getFullYear()}
                    </InformationTile>
                    <InformationTile iconName="person" label="Number of members"
                        >{group.members_count}</InformationTile
                    >
                    <InformationTile iconName="create" label="Posts"
                        >{group.reflections_count}</InformationTile
                    >
                    <InformationTile iconName="school" label="Graduation year"
